...
TEST_CASE("Lebedev grid construction", "[grid]") {
  auto grid = occ::numint::grid::lebedev(110);
  fmt::print("grid:\n{}\n", format_matrix(grid));
  ...
  BENCHMARK("Lebedev 86") {
      return occ::numint::grid::lebedev(86);
  };0

  BENCHMARK("Lebedev 590") {
      return occ::numint::grid::lebedev(590);
  };

  BENCHMARK("Lebedev 5810") {
      return occ::numint::grid::lebedev(5810);
  };
  */
}

TEST_CASE("Becke radial grid points", "[radial]") {
  auto radial = occ::numint::generate_becke_radial_grid(3, 0.6614041435977716);
  ...
  BENCHMARK("Becke radial 10") {
      return occ::numint::generate_becke_radial_grid(10);
  };
...
TEST_CASE("Gauss-Chebyshev radial grid points", "[radial]") {
  auto radial = occ::numint::generate_gauss_chebyshev_radial_grid(3);
...
TEST_CASE("Mura-Knowles radial grid points", "[radial]") {
  auto radial = occ::numint::generate_mura_knowles_radial_grid(3, 1);
...
TEST_CASE("Treutler-Alrichs radial grid points", "[radial]") {
  auto radial = occ::numint::generate_treutler_alrichs_radial_grid(3);
...
TEST_CASE("Euler-Maclaurin radial grid points", "[radial]") {
  auto radial = occ::numint::generate_euler_maclaurin_radial_grid(10, 1.2);
...
TEST_CASE("Becke partitioned atom grid H2", "[grid]") {
  ...
  occ::numint::MolecularGrid mgrid(basis);
