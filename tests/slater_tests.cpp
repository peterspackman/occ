...
TEST_CASE("Grad and rho consistency") {
    ...
    fmt::print("r\n{}\nH.rho\n{}\n", r, rho);
    Vec grad_rho_fd =
        (H.rho(r.array() + 1e-8) - H.rho(r.array() - 1e-8)) / 2e-8;
...
TEST_CASE("Ag atom slater basis density") {
    ...
    expected << 72806.532439, 11476.811931, 2564.204461, 1245.386938,
        865.463781, 597.159964, 392.515352, 255.349478, 173.017297, 127.076663,
        102.004228, 87.439613, 77.454621, 69.117356, 61.243252, 53.538364,
        46.087621, 39.082999, 32.698224, 27.044289, 22.164863, 18.048358,
        14.644541, 11.880118, 9.671165, 7.932082, 6.581441, 5.545408, 4.759384,
        4.168430, 3.726911, 3.397707, 3.151192, 2.964152, 2.818728, 2.701448,
        2.602363, 2.514311;
