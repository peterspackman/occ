// Module worker exposing filesystem operations on a persistent OCC instance.
// Spawn with: new Worker('occ-worker.js', { type: 'module' })
import createOccCliModule from '../dist/occ.js';

let Module = null;
let moduleReady = false;

const modulePromise = createOccCliModule({
