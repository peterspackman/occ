...
PostHFMethod::PostHFMethod(const AOBasis& basis,
    ...
    occ::log::debug("PostHFMethod initialized with SCF energy: {:.10f}", m_scf_energy);
    occ::log::debug("Molecular orbitals: {} occupied, {} virtual", 
