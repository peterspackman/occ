...
Mat IntegralEngine::one_electron_operator(Op op,
  ...
  case Op::overlap: {
    if (spherical) {
      return one_electron_operator_kernel<Op::overlap, Sph>(m_aobasis, m_env,
                                                            shellpairs);
    } else {
      return one_electron_operator_kernel<Op::overlap, Cart>(m_aobasis, m_env,
                                                             shellpairs);
    }
    break;
  }
  case Op::nuclear: {
    if (spherical) {
      return one_electron_operator_kernel<Op::nuclear, Sph>(m_aobasis, m_env,
                                                            shellpairs);
    } else {
      return one_electron_operator_kernel<Op::nuclear, Cart>(m_aobasis, m_env,
                                                             shellpairs);
    }
    break;
  }
  case Op::kinetic: {
    if (spherical) {
      return one_electron_operator_kernel<Op::kinetic, Sph>(m_aobasis, m_env,
                                                            shellpairs);
    } else {
      return one_electron_operator_kernel<Op::kinetic, Cart>(m_aobasis, m_env,
                                                             shellpairs);
    }
    break;
  }
  case Op::coulomb: {
    if (spherical) {
      return one_electron_operator_kernel<Op::coulomb, Sph>(m_aobasis, m_env,
                                                            shellpairs);
    } else {
      return one_electron_operator_kernel<Op::coulomb, Cart>(m_aobasis, m_env,
                                                             shellpairs);
    }
    break;
  }
...
Mat IntegralEngine::rinv_operator_atom_center(size_t atom_index,
  ...
  Mat result;
  if (spherical) {
    result = one_electron_operator_kernel<Op::rinv, Sph>(m_aobasis, m_env,
                                                         shellpairs);
  } else {
    result = one_electron_operator_kernel<Op::rinv, Cart>(m_aobasis, m_env,
                                                          shellpairs);
  }
...
Mat IntegralEngine::effective_core_potential(bool use_shellpair_list) const {
  ...
  Mat result;
  if (spherical) {
    result = ecp_operator_kernel<Sph>(m_aobasis, m_ecp_gaussian_shells, m_ecp,
                                      m_ecp_ao_max_l, m_ecp_max_l, shellpairs);
  } else {
    result = ecp_operator_kernel<Cart>(m_aobasis, m_ecp_gaussian_shells, m_ecp,
                                       m_ecp_ao_max_l, m_ecp_max_l, shellpairs);
  }
...
Vec IntegralEngine::multipole(int order, const MolecularOrbitals &mo,
  ...
  if (mo.kind == R) {
    ...
    case 0:
      if (spherical) {
        return multipole_kernel<0, R, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<0, R, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 1:
      if (spherical) {
        return multipole_kernel<1, R, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<1, R, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 2:
      if (spherical) {
        return multipole_kernel<2, R, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<2, R, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 3:
      if (spherical) {
        return multipole_kernel<3, R, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<3, R, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 4:
      if (spherical) {
        return multipole_kernel<4, R, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<4, R, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    default:
    ...
    case 0:
      if (spherical) {
        return multipole_kernel<0, U, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<0, U, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 1:
      if (spherical) {
        return multipole_kernel<1, U, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<1, U, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 2:
      if (spherical) {
        return multipole_kernel<2, U, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<2, U, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 3:
      if (spherical) {
        return multipole_kernel<3, U, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<3, U, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 4:
      if (spherical) {
        return multipole_kernel<4, U, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<4, U, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    default:
    ...
    case 0:
      if (spherical) {
        return multipole_kernel<0, G, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<0, G, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 1:
      if (spherical) {
        return multipole_kernel<1, G, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<1, G, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 2:
      if (spherical) {
        return multipole_kernel<2, G, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<2, G, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 3:
      if (spherical) {
        return multipole_kernel<3, G, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<3, G, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    case 4:
      if (spherical) {
        return multipole_kernel<4, G, Sph>(m_aobasis, m_env, m_shellpairs, mo,
                                           origin);
      } else {
        return multipole_kernel<4, G, Cart>(m_aobasis, m_env, m_shellpairs, mo,
                                            origin);
      }
      break;
    default:
      ...
      for (auto f2 = 0; f2 != args.dims[2]; ++f2) {
        ...
        for (auto f1 = 0; f1 != args.dims[1]; ++f1) {
          ...
          for (auto f0 = 0; f0 != args.dims[0]; ++f0, ++f0123) {
            ...
            impl::delegate_fock<sk>(D, F, bf0, bf1, bf2, bf3, value);
          }
        }
      }
    }
      ...
      for (auto f2 = 0; f2 != args.dims[2]; ++f2) {
        ...
        for (auto f1 = 0; f1 != args.dims[1]; ++f1) {
          ...
          for (auto f0 = 0; f0 != args.dims[0]; ++f0, ++f0123) {
            const auto bf0 = f0 + args.bf[0];
            const auto value = args.buffer[f0123] * scale;
            impl::delegate_jk<sk>(D, J, K, bf0, bf1, bf2, bf3, value);
          }
        }
      }
    }
...
Mat IntegralEngine::fock_operator(SpinorbitalKind sk,
  ...
  case R:
    if (spherical) {
      return fock_operator_kernel<R, Sph>(m_env, m_aobasis, m_shellpairs, mo,
                                          m_precision, Schwarz);
    } else {
      return fock_operator_kernel<R, Cart>(m_env, m_aobasis, m_shellpairs, mo,
                                           m_precision, Schwarz);
    }
    break;
  case U:
    if (spherical) {
      return fock_operator_kernel<U, Sph>(m_env, m_aobasis, m_shellpairs, mo,
                                          m_precision, Schwarz);
    } else {
      return fock_operator_kernel<U, Cart>(m_env, m_aobasis, m_shellpairs, mo,
                                           m_precision, Schwarz);
    }

  case G:
    if (spherical) {
      return fock_operator_kernel<G, Sph>(m_env, m_aobasis, m_shellpairs, mo,
                                          m_precision, Schwarz);
    } else {
      return fock_operator_kernel<G, Cart>(m_env, m_aobasis, m_shellpairs, mo,
                                           m_precision, Schwarz);
    }
  }
}
...
JKPair IntegralEngine::coulomb_and_exchange(SpinorbitalKind sk,
  ...
  case R:
    if (spherical) {
      return coulomb_and_exchange_kernel<R, Sph>(m_env, m_aobasis, m_shellpairs,
  ...
  case U:
    if (spherical) {
      return coulomb_and_exchange_kernel<U, Sph>(m_env, m_aobasis, m_shellpairs,
                                                 mo, m_precision, Schwarz);
    } else {
  ...
  case G:
    if (spherical) {
      return coulomb_and_exchange_kernel<G, Sph>(m_env, m_aobasis, m_shellpairs,
                                                 mo, m_precision, Schwarz);
    } else {
...
IntegralEngine::coulomb_list(SpinorbitalKind sk,
  ...
  case R:
    if (spherical) {
      return coulomb_kernel_list<R, Sph>(m_env, m_aobasis, m_shellpairs, mos,
                                         m_precision, Schwarz);
    } else {
      return coulomb_kernel_list<R, Cart>(m_env, m_aobasis, m_shellpairs, mos,
                                          m_precision, Schwarz);
    }
    break;
  case U:
    if (spherical) {
      return coulomb_kernel_list<U, Sph>(m_env, m_aobasis, m_shellpairs, mos,
                                         m_precision, Schwarz);
    } else {
      return coulomb_kernel_list<U, Cart>(m_env, m_aobasis, m_shellpairs, mos,
                                          m_precision, Schwarz);
    }

  case G:
    if (spherical) {
      return coulomb_kernel_list<G, Sph>(m_env, m_aobasis, m_shellpairs, mos,
                                         m_precision, Schwarz);
    } else {
      return coulomb_kernel_list<G, Cart>(m_env, m_aobasis, m_shellpairs, mos,
                                          m_precision, Schwarz);
    }
  }
}
...
Mat IntegralEngine::schwarz() const {
  if (is_spherical()) {
    return schwarz_kernel<ShellKind::Spherical>(m_env, m_aobasis, m_shellpairs);
  } else {
    return schwarz_kernel<ShellKind::Cartesian>(m_env, m_aobasis, m_shellpairs);
  }
}
...
Vec IntegralEngine::electric_potential(const MolecularOrbitals &mo,
  ...
  */
  ...
  if (is_spherical()) {
    switch (mo.kind) {
    default: // Restricted
      result += electric_potential_kernel<R, Sph>(m_env, m_aobasis, m_auxbasis,
                                                  m_shellpairs, mo);
      break;
    case U:
      result += electric_potential_kernel<U, Sph>(m_env, m_aobasis, m_auxbasis,
                                                  m_shellpairs, mo);
      break;
    case G:
      result += electric_potential_kernel<G, Sph>(m_env, m_aobasis, m_auxbasis,
                                                  m_shellpairs, mo);
      break;
    }
  } else {
    switch (mo.kind) {
    default: // Restricted
      result += electric_potential_kernel<R, Cart>(m_env, m_aobasis, m_auxbasis,
                                                   m_shellpairs, mo);
      break;
    case U:
      result += electric_potential_kernel<U, Cart>(m_env, m_aobasis, m_auxbasis,
                                                   m_shellpairs, mo);
      break;
    case G:
      result += electric_potential_kernel<G, Cart>(m_env, m_aobasis, m_auxbasis,
                                                   m_shellpairs, mo);
      break;
    }
  }
