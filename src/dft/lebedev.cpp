...
ccgk:
      ...
      that angular integration of polynomials x**k * y**l * z**m, where k+l+m <=
131 can be performed with a relative accuracy of 2e-14 [1]. Note that the
weights are normalised to add up to 1.0.

      For each order n a separate subroutine is provided named
      LD. The parameters X, Y, Z are arrays for the
      cartesian components of each point, and the parameter W is an array for
the weights. The subroutines increase the integer parameter N by number of grid
      points generated. All these routines use the subroutine gen_oh which takes
care of the octahedral symmetry of the grids.
      ...
      are in debt to Dmitri Laikov for giving us permission to make these
routines publically available.
...
ccgk: and the following comments and references for the original of the
subroutine sph_gen_oh:
...
int make_angular_grid_6(
    Eigen::Matrix<double, Eigen::Dynamic, 4, Eigen::RowMajor> &mat) {
  double a = 0, b = 0, v;
  int N = 0;
...
lebedev(int num_points) {
  Eigen::Matrix<double, Eigen::Dynamic, 4, Eigen::RowMajor> result(num_points,
                                                                   4);
  int N = 0;
  switch (num_points) {
  case 0:
    ...
    break;
  case 6:
    N = make_angular_grid_6(result);
    break;
  case 14:
    N = make_angular_grid_14(result);
    break;
  case 26:
    N = make_angular_grid_26(result);
    break;
  case 38:
    N = make_angular_grid_38(result);
    break;
  case 50:
    N = make_angular_grid_50(result);
    break;
  case 74:
    N = make_angular_grid_74(result);
    break;
  case 86:
    N = make_angular_grid_86(result);
    break;
  case 110:
    N = make_angular_grid_110(result);
    break;
  case 146:
    N = make_angular_grid_146(result);
    break;
  case 170:
    N = make_angular_grid_170(result);
    break;
  case 194:
    N = make_angular_grid_194(result);
    break;
  case 230:
    N = make_angular_grid_230(result);
    break;
  case 266:
    N = make_angular_grid_266(result);
    break;
  case 302:
    N = make_angular_grid_302(result);
    break;
  case 350:
    N = make_angular_grid_350(result);
    break;
  case 434:
    N = make_angular_grid_434(result);
    break;
  case 590:
    N = make_angular_grid_590(result);
    break;
  case 770:
    N = make_angular_grid_770(result);
    break;
  case 974:
    N = make_angular_grid_974(result);
    break;
  case 1202:
    N = make_angular_grid_1202(result);
    break;
  case 1454:
    N = make_angular_grid_1454(result);
    break;
  case 1730:
    N = make_angular_grid_1730(result);
    break;
  case 2030:
    N = make_angular_grid_2030(result);
    break;
  case 2354:
    N = make_angular_grid_2354(result);
    break;
  case 2702:
    N = make_angular_grid_2702(result);
    break;
  case 3074:
    N = make_angular_grid_3074(result);
    break;
  case 3470:
    N = make_angular_grid_3470(result);
    break;
  case 3890:
    N = make_angular_grid_3890(result);
    break;
  case 4334:
    N = make_angular_grid_4334(result);
    break;
  case 4802:
    N = make_angular_grid_4802(result);
    break;
  case 5294:
    N = make_angular_grid_5294(result);
    break;
  case 5810:
    N = make_angular_grid_5810(result);
    break;
  default:
    N = 0; // grid size not defined
  }
  assert(N == num_points);
  return result;
}
