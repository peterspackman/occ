...
void register_hkl(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addFunction("d", &HKL::d)
      .addProperty(
          "vector", +[](const HKL *hkl) -> occ::Vec3 { return hkl->vector(); })
      .addFunction(
          "__tostring",
          +[](const HKL *hkl) {
      ...
      .addFunction(
          "hkl_floor",
          +[](const lb::LuaRef &v) { return HKL::floor(table_to_vec3(v)); })
      .addFunction(
          "hkl_ceil",
          +[](const lb::LuaRef &v) { return HKL::ceil(table_to_vec3(v)); })
      .addFunction(
          "hkl_maximum", +[]() { return HKL::maximum(); })
      .addFunction(
          "hkl_minimum", +[]() { return HKL::minimum(); })
      .endNamespace();
}
...
void register_symmetry_operation(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addConstructor<void (*)()>()
      .addPropertyReadWrite("fmt_string", &SymmetryOperationFormat::fmt_string)
      .addPropertyReadWrite("delimiter", &SymmetryOperationFormat::delimiter)
      .endClass()
      ...
      .addStaticFunction(
          "from_string",
          +[](const std::string &s) { return new SymmetryOperation(s); })
      .addFunction("to_int", &SymmetryOperation::to_int)
      .addFunction(
          "to_string",
          +[](const SymmetryOperation *op) { return op->to_string(); })
      .addFunction(
          "to_string_with_format",
          +[](const SymmetryOperation *op, const SymmetryOperationFormat &fmt) {
            return op->to_string(fmt);
          })
      .addFunction("inverted", &SymmetryOperation::inverted)
      .addFunction(
          "translated",
          +[](const SymmetryOperation *op, const lb::LuaRef &t) {
      ...
      .addProperty(
          "rotation",
          +[](const SymmetryOperation *op) -> occ::Mat3 {
            return op->rotation();
          })
      .addFunction(
          "cartesian_rotation",
      ...
      .addProperty(
          "translation",
          +[](const SymmetryOperation *op) -> occ::Vec3 {
      ...
      .addFunction(
          "__mul", +[](const SymmetryOperation *a,
                       const SymmetryOperation &b) { return *a * b; })
      .addFunction(
          "__eq", +[](const SymmetryOperation *a,
                      const SymmetryOperation &b) { return *a == b; })
      .addFunction(
          "__lt", +[](const SymmetryOperation *a,
                      const SymmetryOperation &b) { return *a < b; })
      .addFunction(
          "__le", +[](const SymmetryOperation *a,
                      const SymmetryOperation &b) { return *a <= b; })
      .addFunction(
          "__tostring",
...
void register_spacegroup(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addConstructor<void (*)()>()
      .addStaticFunction(
          "from_number", +[](int n) { return new SpaceGroup(n); })
      .addStaticFunction(
          "from_symbol",
          +[](const std::string &s) { return new SpaceGroup(s); })
      .addStaticFunction(
          "from_symop_strings",
...
void register_unitcell(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addConstructor<void (*)(double, double, double, double, double,
                               double)>()
      .addStaticFunction(
          "default_cell", +[]() { return new UnitCell(); })
      .addStaticFunction(
          "from_lengths_and_angles",
          +[](const lb::LuaRef &lengths, const lb::LuaRef &angles) {
            return new UnitCell(table_to_vec3(lengths), table_to_vec3(angles));
          })
      .addStaticFunction(
      ...
      .addProperty(
          "direct", +[](const UnitCell *c) -> occ::Mat3 { return c->direct(); })
      .addProperty(
          "reciprocal",
      ...
      .addProperty(
          "angles", +[](const UnitCell *c) -> occ::Vec3 { return c->angles(); })
...
void register_crystal(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addFunction(
          "atom_surroundings_default",
          +[](const Crystal *c) { return c->atom_surroundings(0); })
      .addFunction("dimer_symmetry_string", &Crystal::dimer_symmetry_string)
      .addFunction(
...
void register_crystal_region_and_dimers(lua_State *L) {
  lb::getGlobalNamespace(L)
      ...
      .addProperty(
          "atomic_numbers",
          +[](const CrystalAtomRegion *r) -> occ::IVec {
  ...
  lb::getGlobalNamespace(L)
      ...
      .addFunction(
          ...
          +[](const SurfaceCutResult *r) {
            return fmt::format("<SurfaceCutResult n_molecules={} "
                               "depth_scale={:.3f}>",
      ...
      .addConstructor<void (*)()>()
      .addPropertyReadWrite("d_min", &CrystalSurfaceGenerationParameters::d_min)
      .addPropertyReadWrite("d_max", &CrystalSurfaceGenerationParameters::d_max)
      ...
      .addFunction(
          ...
          +[](Surface *s, const std::vector<occ::core::Molecule> &mols,
              double depth, double cut_offset) {
            return s->find_molecule_cell_translations(mols, depth, cut_offset);
          })
      .addFunction(
      ...
      .addFunction(
          ...
          +[](Surface *s, const CrystalDimers &dimers, double cut_offset) {
            return s->count_crystal_dimers_cut_by_surface(dimers, cut_offset);
          })
      .addFunction(
      ...
      .addFunction(
          ...
          +[](const Surface *s, const lb::LuaRef &unique_positions,
              double epsilon) {
            return s->possible_cuts(table_to_mat3n(unique_positions), epsilon);
          })
      .addFunction(
          "possible_cuts_default",
          +[](const Surface *s, const lb::LuaRef &unique_positions) {
            return s->possible_cuts(table_to_mat3n(unique_positions), 1e-6);
          })
      .addFunction(
          "__tostring",
      ...
      .addFunction(
          "generate_surfaces_default",
          +[](const Crystal &crystal) {
            return generate_surfaces(crystal,
                                     CrystalSurfaceGenerationParameters{});
          })
      .endNamespace();
}
