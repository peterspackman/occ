  ...
  lb::getGlobalNamespace(L)
      .beginNamespace("occ")
        ...
        .beginClass<CEParameterizedModel>("CEParameterizedModel")
          ...
          .addPropertyReadWrite("polarization",
                                &CEParameterizedModel::polarization)
        ...
        .beginClass<CEEnergyComponents>("CEEnergyComponents")
          ...
          .addProperty("dispersion_kjmol",
                       &CEEnergyComponents::dispersion_kjmol)
          .addProperty("repulsion_kjmol",
                       &CEEnergyComponents::repulsion_kjmol)
        ...
        .beginClass<CEModelInteraction>("CEModelInteraction")
          ...
          .addFunction("compute",
                       +[](CEModelInteraction *self, qm::Wavefunction &a,
        ...
        .beginClass<WolfParameters>("WolfParameters")
          ...
          .addFunction("__tostring", +[](const WolfParameters *p) {
        ...
        .addFunction("coulomb_energy",
                     +[](const lb::LuaRef &charges,
                         const lb::LuaRef &positions) {
                       return coulomb_energy(table_to_vecx(charges),
                                             table_to_mat3n(positions));
                     })

        .addFunction("coulomb_pair_energy",
                     +[](const lb::LuaRef &charges_a,
                         const lb::LuaRef &positions_a,
                         const lb::LuaRef &charges_b,
                         const lb::LuaRef &positions_b) {
        ...
        .beginClass<CEEnergyModel>("CEEnergyModel")
          ...
          .addProperty("coulomb_scale_factor",
                       &CEEnergyModel::coulomb_scale_factor)
          .addProperty("polarization_scale_factor",
                       &CEEnergyModel::polarization_scale_factor)
          .addFunction("__tostring", +[](const CEEnergyModel *) {
            return std::string{"<CEEnergyModel>"};
          })
        .endClass()
