  ...
  lb::getGlobalNamespace(L)
      .beginNamespace("occ")
        ...
        .beginNamespace("ForceFieldType")
          .addProperty("None_",
                       +[]() { return static_cast<int>(ForceFieldType::None); })
          .addProperty(
              "LennardJones",
          ...
          .addProperty(
              "Custom",
              +[]() { return static_cast<int>(ForceFieldType::Custom); })
        .endNamespace()
        ...
        .beginClass<CrystalEnergyResult>("CrystalEnergyResult")
          ...
          .addFunction("__tostring",
                       +[](const CrystalEnergyResult *r) {
                         return fmt::format(
                             "<CrystalEnergyResult E={:.4f} elec={:.4f} "
                             "sr={:.4f}>",
        ...
        .beginClass<CrystalEnergySetup>("CrystalEnergySetup")
          .addConstructor<void (*)()>()
          .addPropertyReadWrite("cutoff_radius",
                                &CrystalEnergySetup::cutoff_radius)
        ...
        .beginClass<CrystalEnergy>("CrystalEnergy")
          ...
          .addFunction("__tostring",
                       +[](const CrystalEnergy *e) {
                         return fmt::format(
                             "<CrystalEnergy mols={} sites={} pairs={}>",
        ...
        .beginClass<CrystalOptimizerSettings>("CrystalOptimizerSettings")
          ...
          .addPropertyReadWrite("use_ewald",
                                &CrystalOptimizerSettings::use_ewald)
        ...
        .beginClass<CrystalOptimizerResult>("CrystalOptimizerResult")
          ...
          .addProperty("initial_energy",
                       &CrystalOptimizerResult::initial_energy)
        ...
        .beginClass<CrystalOptimizer>("CrystalOptimizer")
          ...
          .addFunction("optimize",
                       +[](CrystalOptimizer *o) { return o->optimize(); })
          .addFunction("states",
        ...
        .addFunction("from_crystal",
                     +[](occ::crystal::Crystal *c,
                         const MultipoleConfig &cfg) {
