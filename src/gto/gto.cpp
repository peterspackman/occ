...
Mat spherical_to_cartesian_transformation_matrix(int l) {
    ...
    case 4: {
	result(0,  0) = 0.375;
	result(0,  3) = 0.21957751641341996535;
	result(0,  5) = -0.87831006565367986142;
	result(0, 10) = 0.375;
	result(0, 12) = -0.87831006565367986142;
	result(0, 14) = 1.0;
	result(1,  2) = -0.89642145700079522998;
	result(1,  7) = -0.40089186286863657703;
	result(1,  9) = 1.19522860933439364;
	result(2,  4) = -0.40089186286863657703;
	result(2, 11) = -0.89642145700079522998;
	result(2, 13) = 1.19522860933439364;
	result(3,  0) = -0.5590169943749474241;
	result(3,  5) = 0.9819805060619657157;
	result(3, 10) = 0.5590169943749474241;
	result(3, 12) = -0.9819805060619657157;
	result(4,  1) = -0.42257712736425828875;
	result(4,  6) = -0.42257712736425828875;
	result(4,  8) = 1.1338934190276816816;
	result(5,  2) = 0.790569415042094833;
	result(5,  7) = -1.0606601717798212866;
	result(6,  4) = 1.0606601717798212866;
	result(6, 11) = -0.790569415042094833;
	result(7,  0) = 0.73950997288745200532;
	result(7,  3) = -1.2990381056766579701;
	result(7, 10) = 0.73950997288745200532;
	result(8,  1) = 1.1180339887498948482;
	result(8,  6) = -1.1180339887498948482;
	break;
    }
