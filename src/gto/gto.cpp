...
Mat cartesian_to_spherical_transformation_matrix(int l) {
    ...
    case 4: {
        result <<
            // g-4 ~ gyx3
            0,
            2.503342941796704538, 0, 0, 0, 0, -2.503342941796704530, 0, 0, 0, 0,
            0, 0, 0, 0,
            // g-3 ~ gx2yz
            ...
            // g3 ~ gzx3
            0, 0, 1.770130769779930531, 0, 0, 0, 0, -5.310392309339791590, 0, 0,
            0, 0, 0, 0, 0,
            // g4 ~ gy4
...
Mat spherical_to_cartesian_transformation_matrix(int l) {
    ...
    auto lambda = [&](int lx1, int ly1, int lz1, int L1) {
        ...
        auto lambda2 = [&](int lx2, int ly2, int lz2, int L2) {
            ...
            double rhs = std::sqrt(
                factorial(lx1) / factorial(2 * lx1) * factorial(ly1) /
