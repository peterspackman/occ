...
std::vector<std::vector<Shell>> read(const std::string &file_dot_g94, bool force_cartesian_d, std::string locale_name)
{
...
#undef LIBINT2_LINE_TO_STRINGSTREAM
  ...
  {
      std::string errmsg = fmt::format("Could not open {} for reading", file_dot_g94);
