...
static std::string normalize_type_key(std::string s) {
...
static std::string infer_site_atom_type_from_label(const std::string& label) {
    auto stripped = label;
...
static int infer_atomic_number_from_type(const std::string& atom_type) {
...
static DmacrysTypeCodeTables build_dmacrys_type_code_tables(
