...
void register_isosurface_bindings() {
    ...
    class_<isosurface::IsosurfaceProperties>("IsosurfaceProperties")
        ...
        .function("addFloat", optional_override([](
        ...
        .function("getFloat", optional_override([](
            const isosurface::IsosurfaceProperties &self, 
            const std::string &name
        ) -> val {
    ...
    class_<isosurface::IsosurfaceGenerationParameters>("IsosurfaceGenerationParameters")
        .constructor<>()
        .property("isovalue", &isosurface::IsosurfaceGenerationParameters::isovalue)
        .property("separation", &isosurface::IsosurfaceGenerationParameters::separation)
        .property("backgroundDensity", &isosurface::IsosurfaceGenerationParameters::background_density)
        .property("flipNormals", &isosurface::IsosurfaceGenerationParameters::flip_normals)
        .property("binaryOutput", &isosurface::IsosurfaceGenerationParameters::binary_output)
        .property("surfaceKind", &isosurface::IsosurfaceGenerationParameters::surface_kind)
        .property("properties", &isosurface::IsosurfaceGenerationParameters::properties);
    ...
    class_<isosurface::Isosurface>("Isosurface")
        ...
        .function("getVertices", optional_override([](const isosurface::Isosurface &surf) {
        ...
        .function("getFaces", optional_override([](const isosurface::Isosurface &surf) {
        ...
        .function("getNormals", optional_override([](const isosurface::Isosurface &surf) {
            size_t numVertices = surf.vertices.cols();
    ...
    class_<isosurface::IsosurfaceCalculator>("IsosurfaceCalculator")
        ...
        .function("setEnvironment", &isosurface::IsosurfaceCalculator::set_environment)
        .function("setWavefunction", &isosurface::IsosurfaceCalculator::set_wavefunction)
        .function("setParameters", &isosurface::IsosurfaceCalculator::set_parameters)
        .function("validate", &isosurface::IsosurfaceCalculator::validate)
        .function("compute", &isosurface::IsosurfaceCalculator::compute)
        .function("computeSurfaceProperty", &isosurface::IsosurfaceCalculator::compute_surface_property)
        .function("isosurface", &isosurface::IsosurfaceCalculator::isosurface, allow_raw_pointers())
        .function("requiresCrystal", &isosurface::IsosurfaceCalculator::requires_crystal)
        .function("requiresWavefunction", &isosurface::IsosurfaceCalculator::requires_wavefunction)
        .function("requiresEnvironment", &isosurface::IsosurfaceCalculator::requires_environment)
        .function("haveCrystal", &isosurface::IsosurfaceCalculator::have_crystal)
        .function("haveWavefunction", &isosurface::IsosurfaceCalculator::have_wavefunction)
        .function("haveEnvironment", &isosurface::IsosurfaceCalculator::have_environment)
        .function("errorMessage", &isosurface::IsosurfaceCalculator::error_message);
    ...
    function("surfaceToString", optional_override([](isosurface::SurfaceKind kind) {
        return std::string(isosurface::surface_to_string(kind));
    }));

    function("propertyToString", optional_override([](isosurface::PropertyKind kind) {
    ...
    function("surfaceRequiresWavefunction", &isosurface::surface_requires_wavefunction);
    function("propertyRequiresWavefunction", &isosurface::property_requires_wavefunction);
    function("surfaceRequiresEnvironment", &isosurface::surface_requires_environment);
    function("propertyRequiresEnvironment", &isosurface::property_requires_environment);
