...
Vec build_X_vector(const IVec &atomic_numbers, const Vec &cn, double charge = 0.0) {
    const int N = atomic_numbers.rows();
...
Vec eeq_partial_charges(const IVec &atomic_numbers,
			const Mat3N &positions, double charge) {
