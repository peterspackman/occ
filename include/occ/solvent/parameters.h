...
struct SMDSolventParameters {
    ...
    double
        aromaticity; // fraction of non-H solvent atoms that are aromatic carbon
    double electronegative_halogenicity; // fraction of non-H solvent atoms that
                                         // are F, Cl or Br
    bool is_water{false};                // flag if this is water
};

static inline robin_hood::unordered_map<std::string, double>
    dielectric_constant{
        {"acetic acid", 6.2528},
        {"acetone", 20.493},
        {"acetonitrile", 35.688},
 ...
 */
static inline robin_hood::unordered_map<std::string, SMDSolventParameters>
    smd_solvent_parameters{
        {"1,1,1-trichloroethane",
         {1.4379, 1.4313, 0.0, 0.09, 36.24, 7.0826, 0.0, 0.60}},
        {"1,1,2-trichloroethane",
         {1.4717, 1.4689, 0.13, 0.13, 48.97, 7.1937, 0.0, 0.60}},
        {"1,2,4-trimethylbenzene",
         {1.5048, 1.5024, 0.0, 0.19, 42.03, 2.3653, 0.667, 0.0}},
        {"1,2-dibromoethane",
         {1.5387, 1.5364, 0.10, 0.17, 56.93, 4.9313, 0.0, 0.5}},
        {"1,2-dichloroethane",
         {1.4448, 1.4425, 0.10, 0.11, 45.86, 10.125, 0.0, 0.5}},
        {"1,2-ethanediol",
         {1.4318, 1.4306, 0.58, 0.78, 69.07, 40.245, 0.0, 0.5}},
        {"1,4-dioxane", {1.4224, 1.4204, 0.00, 0.64, 47.14, 2.2099, 0.0, 0.0}},
        {"1-bromo-2-methylpropane",
         {1.4348, 1.4349, 0.00, 0.12, 34.69, 7.7792, 0.0, 0.2}},
        {"1-bromooctane",
         {1.4524, 1.4500, 0.0, 0.12, 41.28, 5.0244, 0.0, 0.111}},
        {"1-bromopentane",
         {1.4447, 1.4420, 0.00, 0.12, 38.7, 6.269, 0.0, 0.250}},
        {"1-bromopropane",
         {1.4343, 1.4315, 0.0, 0.12, 36.36, 8.0496, 0.0, 0.250}},
        ...
        {"1-fluorooctane",
         {1.3935, 1.3927, 0.0, 0.10, 33.92, 3.89, 0.0, 0.111}},
        ...
        {"1-iodopropane",
         {1.5058, 1.5027, 0.00, 0.15, 41.45, 6.9626, 0.0, 0.0}},
        {"1-nitropropane",
         {1.4018, 1.3996, 0.00, 0.31, 43.32, 23.73, 0.0, 0.0}},
        ...
        {"2,2,2-trifluoroethanol",
         {1.2907, -1, 0.57, 0.25, 42.02, 26.726, 0.0, 0.5}},
        {"2,2,4-trimethylpentane",
         {1.3915, 1.3889, 0.00, 0.00, 26.38, 1.9358, 0.0, 0.0}},
        {"2,4-dimethylpentane",
         {1.3815, 1.3788, 0.0, 0.00, 25.42, 1.8939, 0.0, 0.0}},
        {"2,4-dimethylpyridine",
         {1.5010, 1.4985, 0.0, 0.63, 46.86, 9.4176, 0.625, 0.0}},
        {"2,6-dimethylpyridine",
         {1.4953, 1.4952, 0.0, 0.63, 44.64, 7.1735, 0.625, 0.0}},
        {"2-bromopropane",
         {1.4251, 1.4219, 0.00, 0.14, 33.46, 9.3610, 0.0, 0.25}},
        {"2-butanol", {1.3978, 1.3949, 0.33, 0.56, 32.44, 15.944, 0.0, 0.0}},
        {"2-chlorobutane",
         {1.3971, 1.3941, 0.00, 0.12, 31.1, 8.3930, 0.0, 0.2}},
        {"2-heptanone", {1.4088, 1.4073, 0.0, 0.51, 37.6, 11.658, 0.0, 0.0}},
        {"2-hexanone", {1.4007, 1.3987, 0.0, 0.51, 36.63, 14.136, 0.0, 0.0}},
        {"2-methoxyethanol",
         {1.4024, 1.4003, 0.30, 0.84, 44.39, 17.2, 0.0, 0.0}},
        {"2-methyl-1-propanol",
         {1.3955, 1.3938, 0.37, 0.48, 32.38, 16.777, 0.0, 0.0}},
        {"2-methyl-2-propanol",
         {1.3878, 1.3852, 0.31, 0.60, 28.73, 12.47, 0.0, 0.0}},
        {"2-methylpentane", {1.3715, 1.3687, 0.0, 0.00, 24.3, 1.89, 0.0, 0.0}},
        {"2-methylpyridine",
         {1.4957, 1.4984, 0.0, 0.58, 47.5, 9.9533, 0.714, 0.0}},
        {"2-nitropropane",
         {1.3944, 1.3923, 0.00, 0.33, 42.16, 25.654, 0.00, 0.0}},
        ...
        {"3-methylpyridine",
         {1.5040, 1.5043, 0.0, 0.54, 49.61, 11.645, 0.714, 0.0}},
        ...
        {"butanoic acid",
         {1.3980, 1.3958, 0.60, 0.45, 37.49, 2.9931, 0.0, 0.0}},
        ...
        {"o-chlorotoluene",
         {1.5268, 1.5233, 0.00, 0.07, 47.43, 4.6331, 0.75, 0.125}},
        ...
        {"cyclohexanone",
         {1.4507, 1.4507, 0.00, 0.56, 49.76, 15.619, 0.00, 0.0}},
        {"cyclopentane", {1.4065, 1.4036, 0.00, 0.00, 31.49, 1.9608, 0.0, 0.0}},
        {"cyclopentanol", {1.4530, -1, 0.32, 0.56, 46.8, 16.989, 0.0, 0.0}},
        {"cyclopentanone",
         {1.4366, 1.4347, 0.00, 0.52, 47.21, 13.58, 0.0, 0.0}},
        {"decalin (cis/trans mixture)",
         {1.4753, 1.472, 0.00, 0.00, 43.82, 2.196, 0.0, 0.0}},
        {"cis-decalin", {1.4810, 1.4788, 0.00, 0.00, 45.45, 2.2139, 0.0, 0.0}},
        {"n-decane", {1.4102, 1.4094, 0.00, 0.00, 33.64, 1.9846, 0.0, 0.0}},
        {"dibromomethane",
         {1.5420, 1.5389, 0.10, 0.10, 56.21, 7.2273, 0.0, 0.667}},
        {"butylether", {1.3992, 1.3968, 0.00, 0.45, 35.98, 3.0473, 0.0, 0.0}},
        {"o-dichlorobenzene",
         {1.5515, 1.5491, 0.00, 0.04, 52.72, 9.9949, 0.75, 0.25}},
        {"E-1,2-dichloroethene",
         {1.4454, 1.4435, 0.09, 0.05, 37.13, 2.14, 0.0, 0.5}},
        {"Z-1,2-dichloroethene",
         {1.4490, 1.4461, 0.11, 0.05, 39.8, 9.2, 0.0, 0.5}},
        {"dichloromethane",
         {1.4242, 1.4212, 0.10, 0.05, 39.15, 8.93, 0.0, 0.667}},
        {"diethylether", {1.3526, 1.3496, 0.00, 0.41, 23.96, 4.2400, 0.0, 0.0}},
        {"diethylsulfide",
         {1.4430, 1.4401, 0.00, 0.32, 35.36, 5.723, 0.0, 0.0}},
        {"diethylamine", {1.3864, 1.3825, 0.08, 0.69, 28.57, 3.5766, 0.0, 0.0}},
        {"diiodomethane", {1.7425, 1.738, 0.05, 0.23, 95.25, 5.32, 0.0, 0.0}},
        {"diisopropyl ether",
         {1.3679, 1.3653, 0.00, 0.41, 24.86, 3.38, 0.0, 0.0}},
        {"cis-1,2-dimethylcyclohexane",
         {1.4360, 1.4336, 0.00, 0.00, 36.28, 2.06, 0.0, 0.0}},
        {"dimethyldisulfide",
         {1.5289, 1.522, 0.00, 0.28, 48.06, 9.6, 0.0, 0.0}},
        {"N,N-dimethylacetamide",
         {1.4380, 1.4358, 0.00, 0.78, 47.62, 37.781, 0.0, 0.0}},
        {"N,N-dimethylformamide",
         {1.4305, 1.4280, 0.00, 0.74, 49.56, 37.219, 0.0, 0.0}},
        {"dimethylsulfoxide",
         {1.4783, 1.4783, 0.00, 0.88, 61.78, 46.826, 0.0, 0.0}},
        {"diphenylether", {1.5787, -1, 0.00, 0.20, 38.5, 3.73, 0.923, 0.0}},
        {"dipropylamine",
         {1.4050, 1.4018, 0.08, 0.69, 32.11, 2.9112, 0.0, 0.0}},
        ...
        {"ethylethanoate",
         {1.3723, 1.3704, 0.00, 0.45, 33.67, 5.9867, 0.0, 0.0}},
        {"ethylmethanoate",
         {1.3599, 1.3575, 0.00, 0.38, 33.36, 8.3310, 0.0, 0.0}},
        {"ethylphenylether",
         {1.5076, 1.5254, 0.00, 0.32, 46.65, 4.1797, 0.667, 0.0}},
        {"ethylbenzene",
         {1.4959, 1.4932, 0.00, 0.15, 41.38, 2.4339, 0.75, 0.0}},
        {"fluorobenzene",
         {1.4684, 1.4629, 0.00, 0.10, 38.37, 5.42, 0.857, 0.143}},
        ...
        {"iodobenzene",
         {1.6200, 1.6172, 0.00, 0.12, 55.72, 4.5470, 0.857, 0.0}},
        {"iodoethane", {1.5133, 1.5100, 0.00, 0.15, 40.96, 7.6177, 0.0, 0.0}},
        {"iodomethane", {1.5380, 1.5270, 0.00, 0.13, 43.67, 6.8650, 0.0, 0.0}},
        {"isopropylbenzene",
         {1.4915, 1.4889, 0.00, 0.16, 39.85, 2.3712, 0.667, 0.0}},
        {"p-isopropyltoluene",
         {1.4909, 1.4885, 0.00, 0.19, 38.34, 2.2322, 0.600, 0.0}},
        {"mesitylene", {1.4994, 1.4968, 0.00, 0.19, 39.65, 2.2650, 0.667, 0.0}},
        {"methanol", {1.3288, 1.3265, 0.43, 0.47, 31.77, 32.613, 0.0, 0.0}},
        {"methylbenzoate",
         {1.5164, 1.5146, 0.00, 0.46, 53.5, 6.7367, 0.600, 0.0}},
        {"methylbutanoate",
         {1.3878, 1.3847, 0.00, 0.45, 35.44, 5.5607, 0.0, 0.0}},
        {"methylethanoate",
         {1.3614, 1.3589, 0.00, 0.45, 35.59, 6.8615, 0.0, 0.0}},
        {"methylmethanoate",
         {1.3433, 1.3415, 0.00, 0.38, 35.06, 8.8377, 0.0, 0.0}},
        {"methylpropanoate",
         {1.3775, 1.3742, 0.00, 0.45, 35.18, 6.0777, 0.0, 0.0}},
        {"N-methylaniline",
         {1.5684, 1.5681, 0.17, 0.43, 53.11, 5.9600, 0.75, 0.0}},
        {"methylcyclohexane",
         {1.4231, 1.4206, 0.00, 0.00, 33.52, 2.024, 0.0, 0.0}},
        {"N-methylformamide(E/Zmixture)",
         {1.4319, 1.4310, 0.40, 0.55, 55.44, 181.56, 0.0, 0.0}},
        {"nitrobenzene",
         {1.5562, 1.5030, 0.00, 0.28, 57.54, 34.809, 0.667, 0.0}},
        {"nitroethane", {1.3917, 1.3897, 0.02, 0.33, 46.25, 28.29, 0.0, 0.0}},
        {"nitromethane", {1.3817, 1.3796, 0.06, 0.31, 52.58, 36.562, 0.0, 0.0}},
        {"o-nitrotoluene",
         {1.5450, 1.5474, 0.0, 0.27, 59.12, 25.669, 0.6, 0.0}},
