...
struct Options {
  ...
  /// Lebedev order per atom for the cavity. 146 suffices for energies;
  /// σ-profiles need more to avoid a spiky histogram.
  ...
  /// from unity is 1e-10.
  ///
  /// The probe defaults to zero. Although the published COSMO-SAC databases
  /// were generated by codes reporting a 1.3 Å solvent radius, their cavity
  /// areas and volumes match a plain union of Klamt spheres to 1–3%, whereas
  /// applying a 1.3 Å probe here loses 18–35% of the area.
  static Options conductor(double probe_radius_angs = 0.0,
