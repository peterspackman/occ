...
struct Options {
  ...
  /// from unity is 1e-10.
  ///
  /// The probe defaults to zero. Although the published σ-profile
  /// databases were generated by codes reporting a 1.3 Å solvent radius,
  /// their cavity areas and volumes match a plain union of Klamt spheres to
  /// 1–3%, whereas applying a 1.3 Å probe here loses 18–35% of the area.
