...
public:
   ...
   */
  LinearMultipoleCalculator(const occ::qm::Wavefunction &wfn, 
...
private:
   ...
   * @param site_multipoles Vector to store multipole contributions
   */
  void process_shell_pair(const occ::qm::Shell &shell_i, const occ::qm::Shell &shell_j,
                         int i_shell_idx, int j_shell_idx,
   ...
   * @param site_multipoles Vector to store multipole contributions
   */
  void process_primitive_pair(const occ::qm::Shell &shell_i, const occ::qm::Shell &shell_j,
                             int i_prim, int j_prim,
                             const Mat &d_block,
                             int atom_i, int atom_j,
                             std::vector<Mult> &site_multipoles);
   ...
   */
  void calculate_slice_integrals(double aa, int la, int lb, double za, double zb, 
                                double z1, double z2, 
