...
/**
 * @brief Handles analytical calculation of multipole moments using Gauss-Hermite quadrature
 */
...
public:
   ...
   */
  void calculate_primitive_contribution(
