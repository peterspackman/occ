...
template<class T>
constexpr T pi = T(3.141592653589793238462643383279502884197169399375105820974944);
template<class T>
...
template<class T>
constexpr T e = T(2.7182818284590452353602874713526624977572470936999595749669676);
...
template<class T>
constexpr T rad_per_deg = T(pi<T>/180.0);
template<class T>
constexpr T deg_per_rad = T(180.0/pi<T>);


template<class T>
constexpr T planck = T(6.62607015000000000000000e-34);

template<class T>
constexpr T avogadro = T(6.02214076000000000000000e23);


template<class T>
constexpr T speed_of_light = T(2.99792458000000000000000e8);

template<class T>
constexpr T molar_gas_constant = T(8.314462618);

template<class T>
constexpr T molar_mass_constant = T(0.99999999965e-3);

template<class T>
constexpr T celsius = T(273.15);

template<class T>
constexpr T boltzmann = T(1.38066244e-23);
