...
public:
  ...
  inline const auto &first_bf() const noexcept { return m_aobasis.first_bf(); }
  ...
  std::vector<Mat> coulomb_list(SpinorbitalKind,
  ...
  Mat rinv_operator_atom_center(size_t atom_index,
                                bool use_shellpair_list = true) const;
