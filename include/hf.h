...
public:
    ...
    std::pair<MatRM, MatRM> compute_JK(const MatRM& D, double precision = std::numeric_limits<double>::epsilon(),  const MatRM& Schwarz = MatRM()) const;
    ...
    std::tuple<MatRM, MatRM, MatRM, MatRM> compute_JK_unrestricted(const MatRM& Da, const MatRM& Db, double precision = std::numeric_limits<double>::epsilon(),  const MatRM& Schwarz = MatRM()) const;
